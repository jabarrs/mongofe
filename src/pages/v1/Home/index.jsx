...
const Home = () => {
  ...
  const deleteProduct = async (_id) => {
    ...
    if (deleteItem) {
      axios
        .delete(process.env.REACT_APP_BASE_URL + '/v1/product/' + _id)
        .then(() => {
  ...
  useEffect(() => {
    axios
      .get(process.env.REACT_APP_BASE_URL + '/v1/product?name=' + search)
              ...
              return (
                <tr key={index}>
                  ...
                  <td className="text-center">
                    ...
                    <Link to={`/edit/${_id}`} className="btn btn-sm btn-warning">
                      Edit
                    </Link>
