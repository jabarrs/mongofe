...
const Editv2 = () => {
  ...
  useEffect(() => {
    axios
      .get(process.env.REACT_APP_BASE_URL + '/v2/product/' + id)
      .then((res) => {
  ...
  const handleChange = (e) => {
    ...
    setProduct((a) => {
      return type === 'number' ? { ...a, [name]: Number(value) } : { ...a, [name]: value };
    });
  };
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(process.env.REACT_APP_BASE_URL + '/v2/product/' + id, {
        name,
        price,
        stock,
        status,
    ...
    <div className="main">
      <div className="card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Input name="status" type="checkbox" label="Active" defaultChecked={true} value={product.status} onChange={handleChangeCheckbox} />
